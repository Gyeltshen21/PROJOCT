...
public class ParentSetNewPasswordActivity extends AppCompatActivity {
    ...
    public void updateNewPassword(View view) {
        ...
        if(!validatePassword()){
            ...
            Intent intent = new Intent(ParentSetNewPasswordActivity.this, UpdatedForgotPasswordActivity.class);
