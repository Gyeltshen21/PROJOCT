...
public class AdminNotificationAdapter extends FirebaseRecyclerAdapter<AdminNotificationHelperClass, AdminNotificationAdapter.myViewHolder> {
     ...
     * @param options
     */
    public AdminNotificationAdapter(@NonNull FirebaseRecyclerOptions<AdminNotificationHelperClass> options) {
        super(options);
    }
            ...
            public void onClick(View v) {
                ...
                AdminNotificationBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("AdminNotification").child(getRef(position).getKey()).updateChildren(map)
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        FirebaseDatabase.getInstance().getReference().child("AdminNotification").child(getRef(position).getKey()).removeValue();
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.admin_notification_single_row,parent,false);
