            ...
            public void onClick(View v) {
                ...
                AdminNotificationBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("TeacherNews").child(getRef(position).getKey()).updateChildren(map)
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        FirebaseDatabase.getInstance().getReference().child("TeacherNews").child(getRef(position).getKey()).removeValue();
